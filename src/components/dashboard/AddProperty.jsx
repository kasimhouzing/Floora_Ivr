                ...
                <div className="col-xl-6">
                  <div className="card">
                    <div className="card-body">
                      ...
                      <p className="sub-header">Add a new property to your list</p>
                      <form>
                        <div className="row">
                          <div className="col-md-6 mb-3">
                            <label htmlFor="example-email" className="form-label">Property Name</label>
                            <input type="email" id="example-email" name="example-email" className="form-control" placeholder="House 123" />
                          </div>
                          <div className="col-md-6 mb-3">
                            <label htmlFor="example-select" className="form-label">Property Type</label>
                        ...
                        <div className="mb-3">
                          <label htmlFor="example-textarea" className="form-label">Property Description</label>
                          <textarea className="form-control" id="example-textarea" rows="5"></textarea>
                        </div>
                        <div className="mb-3">
                          <label htmlFor="example-select" className="form-label">Number of Bedrooms</label>
                          <select className="form-select" id="example-select">
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                        ...
                        <div className="mb-3">
                          <label htmlFor="example-select" className="form-label">Number of Bathrooms</label>
                          <select className="form-select" id="example-select">
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                        ...
                        <div className="mb-3">
                          <label htmlFor="example-select" className="form-label">Property Status</label>
                          <select className="form-select" id="example-select">
                ...
                <div className="col-xl-6">
                  <div className="card">
                    <div className="card-body">
                      ...
                      <p className="sub-header">Upload images of the property</p>
                      <form action="#" className="dropzone">
                        ...
                        <div className="dz-message needsclick">
                          ...
                          <span className="text-muted font-13">
                            (This is a demo. All files are <b>not</b> saved on the server.)
                          </span>
                        </div>
                      </form>
                    </div>
