...
// //               <div className="card-body">
// //                 <h5 className="mt-0">
// //                   <i className="ri-line-chart-line me-1"></i> Recent Calls
// //                 </h5>
// //                 <div className="table-responsive">
...
// //                       <tr>
// //                         <td>#7543</td>
// //                         <td>321 Oak St, Springfield</td>
// //                         <td>
// //                           <span className="text-muted">10:00 AM</span>
// //                         </td>
// //                         <td>
// //                           <span className="text-muted">3:15</span>
// //                         </td>
// //                       </tr>
// //                       <tr>
// //                         <td>#7544</td>
// //                         <td>123 Maple Ave, Sunnyvale</td>
// //                         <td>
// //                           <span className="text-muted">11:30 AM</span>
// //                         </td>
// //                         <td>
// //                           <span className="text-muted">1:40</span>
// //                         </td>
// //                       </tr>
// //                       <tr>
// //                         <td>#7545</td>
// //                         <td>456 Pine Rd, Rivertown</td>
// //                         <td>
// //                           <span className="text-muted">11:45 AM</span>
// //                         </td>
// //                         <td>
    ...
    <Layout>
            ...
            <div className="card-body">
              <div className="d-flex align-items-center">
                <div className="avatar-sm flex-shrink-0">
                  <span className="avatar-title bg-primary-subtle text-primary rounded-circle fs-xl">
                    <i className="ti ti-users-group"></i>
                  </span>
                </div>
                <div className="flex-grow-1 ms-3">
                  <h6 className="fs-15 fw-semibold text-muted">Total Calls</h6>
                  <h4 className="mt-2 mb-0 fs-22">
                    <span
        ...
        <div className="col-xxl-3 col-sm-6">
          <div className="card card-animate">
            <div className="card-body">
              <div className="d-flex align-items-center">
                <div className="avatar-sm flex-shrink-0">
                  <span className="avatar-title bg-warning-subtle text-warning rounded-circle fs-xl">
                    <i className="ti ti-phone-outgoing"></i>
                  </span>
                </div>
                <div className="flex-grow-1 ms-3">
                  <h6 className="fs-15 fw-semibold text-muted">
                    Outbound Calls
                  </h6>
                  <h4 className="mt-2 mb-0 fs-22">
                    <span
        ...
        <div className="col-xxl-3 col-sm-6">
          <div className="card card-animate">
            <div className="card-body">
              <div className="d-flex align-items-center">
                <div className="avatar-sm flex-shrink-0">
                  <span className="avatar-title bg-info-subtle text-info rounded-circle fs-xl">
                    <i className="ti ti-phone-incoming"></i>
                  </span>
                </div>
                <div className="flex-grow-1 ms-3">
                  <h6 className="fs-15 fw-semibold text-muted">
        ...
        <div className="col-xxl-3 col-sm-6">
          <div className="card card-animate">
            <div className="card-body">
              <div className="d-flex align-items-center">
                <div className="avatar-sm flex-shrink-0">
                  <span className="avatar-title bg-success-subtle text-success rounded-circle fs-xl">
      ...
      <div className="row">
        <div className="col-xl-6">
          <div className="card">
            <div className="d-flex card-header justify-content-between align-items-center">
              <h5 className="card-title">Daily Call Volume</h5>
              <div className="dropdown">
                <a
                  href="#"
            ...
            <div className="card-body pt-0">
              <div id="traffic-source" className="apex-charts mt-3" dir="ltr">
                {/* Chart placeholder */}
                <img
                  src="https://via.placeholder.com/500x300.png?text=Daily+Call+Volume+Chart"
                  alt="Daily Call Volume Chart"
                  className="img-fluid"
                />
              </div>
            </div>
        ...
        <div className="col-xl-6">
          <div className="card">
            <div className="d-flex card-header justify-content-between align-items-center">
              <h5 className="card-title">Recent Calls</h5>
